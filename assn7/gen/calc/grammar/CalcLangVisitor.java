...
public interface CalcLangVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitVarStmt(CalcLangParser.VarStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitWhileStmt(CalcLangParser.WhileStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIfStmt(CalcLangParser.IfStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIfElseStmt(CalcLangParser.IfElseStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitBlockStmt(CalcLangParser.BlockStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitStringExpr(CalcLangParser.StringExprContext ctx);
	/**
